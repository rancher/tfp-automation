...
func CreateRKE2Cluster(file *os.File, newFile *hclwrite.File, rootBody *hclwrite.Body, terraformConfig *config.TerraformConfig,
	...
	serverScriptPath := filepath.Join(userDir, "go/src/github.com/rancher/tfp-automation/standalone/framework/resources/rke2/init-server.sh")
	newServersScriptPath := filepath.Join(userDir, "go/src/github.com/rancher/tfp-automation/standalone/framework/resources/rke2/add-servers.sh")
