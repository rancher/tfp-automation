...
func (p *TfpProxyUpgradeRancherTestSuite) TestTfpUpgradeProxyRancher() {
	...
	p.provisionAndVerifyCluster("Pre_Upgrade_Proxy", clusterIDs, testUser, testPassword)
	...
	p.provisionAndVerifyCluster("Post_Upgrade_Proxy", clusterIDs, testUser, testPassword)
