...
func (p *TfpProxyProvisioningTestSuite) TestTfpProxyProvisioning() {
	...
	tests := []struct {
		...
		{"Proxy_RKE2", nodeRolesDedicated, modules.EC2RKE2},
		{"Proxy_RKE2_Windows_2019", nil, modules.CustomEC2RKE2Windows2019},
		{"Proxy_RKE2_Windows_2022", nil, modules.CustomEC2RKE2Windows2022},
		{"Proxy_K3S", nodeRolesDedicated, modules.EC2K3s},
	}
