...
func apply(t *testing.T, rancherConfig *rancher.Config, terraformConfig *config.TerraformConfig,
	...
	err := setAuthProvider(terraformConfig, enabled, newFile, rootBody, file)
...
func setAuthProvider(terraformConfig *config.TerraformConfig, enabled bool, newFile *hclwrite.File,
