...
func (s *TfpSanityUpgradeRancherTestSuite) TestTfpUpgradeRancher() {
	...
	s.provisionAndVerifyCluster("Pre_Upgrade_Sanity_", clusterIDs, testUser, testPassword)
	...
	s.provisionAndVerifyCluster("Post_Upgrade_Sanity_", clusterIDs, testUser, testPassword)
