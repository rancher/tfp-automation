...
func (a *TfpAirgapUpgradeRancherTestSuite) TestTfpUpgradeAirgapRancher() {
	...
	ranchers.CleanupPreUpgradeClusters(a.T(), a.client, a.terraformOptions, a.terratestConfig, a.cattleConfig, newFile, rootBody, file)

	standardUserClient, newFile, rootBody, file, standardToken, testUser, testPassword = ranchers.SetupResources(a.T(), a.client, a.rancherConfig, a.terratestConfig, a.terraformOptions)

	a.rancherConfig, a.terraformConfig, a.terratestConfig, _ = config.LoadTFPConfigs(a.cattleConfig)
	a.provisionAndVerifyCluster("Airgap_Post_Rancher_Upgrade_", allClusterIDs, newFile, rootBody, file, standardUserClient, standardToken, testUser, testPassword)
...
func (a *TfpAirgapUpgradeRancherTestSuite) provisionAndVerifyCluster(name string, clusterIDs []string, newFile *hclwrite.File,
	rootBody *hclwrite.Body, file *os.File, standardUserClient *rancher.Client, standardToken, testUser, testPassword string) []string {
