...
func (a *TfpAirgapUpgradeRancherTestSuite) TestTfpUpgradeAirgapRancher() {
	...
	a.provisionAndVerifyCluster("Pre_Upgrade_Airgap ", clusterIDs, testUser, testPassword)
	...
	a.provisionAndVerifyCluster("Post_Upgrade_Airgap ", clusterIDs, testUser, testPassword)
