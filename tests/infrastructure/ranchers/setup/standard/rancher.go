...
func CreateRancher(t *testing.T, provider string, cattleConfig map[string]any) error {
...
func SetupRancher(t *testing.T, session *session.Session, moduleKeyPath string, cattleConfig map[string]any) (*rancher.Client, string, *terraform.Options,
