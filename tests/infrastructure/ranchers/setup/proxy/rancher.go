...
func CreateProxyRancher(t *testing.T, provider string, cattleConfig map[string]any) error {
...
func SetupProxyRancher(t *testing.T, session *session.Session, moduleKeyPath string, cattleConfig map[string]any) (*rancher.Client, string, string,
