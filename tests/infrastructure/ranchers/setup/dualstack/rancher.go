...
func CreateDualStackRancher(t *testing.T, provider string, cattleConfig map[string]any) error {
	...
	_, err := dualstack.CreateMainTF(t, terraformOptions, keyPath, rancherConfig, terraformConfig.RancherTerraformConfig(), terratestConfig)
	if err != nil {
		return err
	}
...
func SetupDualStackRancher(t *testing.T, session *session.Session, moduleKeyPath string, cattleConfig map[string]any) (*rancher.Client, string, *terraform.Options,
	*terraform.Options, map[string]any) {
	...
	serverNodeOne, err := dualstack.CreateMainTF(t, standaloneTerraformOptions, keyPath, rancherConfig, terraformConfig.RancherTerraformConfig(), terratestConfig)
