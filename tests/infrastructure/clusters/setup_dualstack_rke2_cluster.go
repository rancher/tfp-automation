...
// CreateDualStackRKE2Cluster is a function that creates a dualstack RKE2 cluster either via CLI or web application
func CreateDualStackRKE2Cluster(t *testing.T, provider string) error {
