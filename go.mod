...
replace (
	...
	github.com/rancher/tfp-automation/tests/provisioning => github.com/rancher/tfp-automation/tests/provisioning v0.0.0-20231221235250-846fa29bfbe1
...
require (
	...
	github.com/rancher/tfp-automation v0.0.0-20231221235250-846fa29bfbe1
)
