...
func importNodes(rootBody *hclwrite.Body, terraformConfig *config.TerraformConfig, nodeOnePublicDNS, kubeConfig, importCommand,
	...
	nullResourceBlockBody, provisionerBlockBody := imported.CreateImportedNullResourceCopy(rootBody, terraformConfig, nodeOnePublicDNS, copyScriptName, clusterName)
	...
	nullResourceBlockBody, provisionerBlockBody = imported.CreateImportedNullResourceCopy(rootBody, terraformConfig, nodeOnePublicDNS, importClusterName, clusterName)
