...
RUN cp /root/.terraform.d/plugins/terraform.local/local/rancher2/${RANCHER2_PROVIDER_VERSION}/linux_amd64/terraform-provider-rancher2 /home/jenkins/workspace/rancher_qa/tfp-automation
