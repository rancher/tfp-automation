...
import (
	...
	format "github.com/rancher/tfp-automation/functions/format"
...
func SetRKE2K3s(t *testing.T, k8sVersion string, nodePools []config.Nodepool, file *os.File) (done bool, err error) {
